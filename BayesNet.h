...
private:
	...
	map<int, float> AgiveDBE = { {7, 0.50909},{6, 0.93333},{5, 0.80576},{4, 0.96137} };
	map<int, float> BgiveACEF = { {15, 0.10638},{14, 0.21739},{13, 0.61644},{12, 0.78947},{11, 0.40000},{10, 0.40000},{9, 0.36000},{8, 0.90000},
								  {7, 0.32258},{6, 0.52632},{5, 0.74074},{4, 0.86957},{3, 0.14286},{2, 0.72727},{1, 0.50000},{0, 0.94118} };
	map<int, float> CgiveBF = { {3, 0.38462},{2, 0.13514},{1, 0.57143},{0, 0.14286} };
	map<int, float> EgiveGABF = { {15, 0.00613},{14, 0.01597},{13, 0.19814},{12, 0.75000},{11, 0.17489},{10, 0.75000},{9, 0.69231},{8, 0.94737} };
	map<int, float> FgiveGBCE = { {15, 0.20000},{14, 0.66667},{13, 0.05882},{12, 0.32468},{11, 0.42257},{10, 0.82353},{9, 0.50000},{8, 0.88889} };
};
